...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/batch-reactive.js");
/******/ })
/************************************************************************/
/******/ ({
...
var subscribe = function subscribe(batches, callback) {
  var index = 0;
  return Object(_common__WEBPACK_IMPORTED_MODULE_0__["raf"])(function () {
...
var generateBatches = function generateBatches(amount) {
  return new Array(1e3).fill(null).map(function () {
    return new Array(amount).fill(null).map(function (v, index) {
      return {
        rule: "box-".concat(index),
        color: Object(_common__WEBPACK_IMPORTED_MODULE_0__["getRandomColor"])()
      };
    });
  });
};

Object(_common__WEBPACK_IMPORTED_MODULE_0__["renderControls"])(function (amount) {
  var _renderObjects = Object(_common__WEBPACK_IMPORTED_MODULE_0__["renderObjects"])(amount),
      remove = _renderObjects.remove,
      update = _renderObjects.update;

  var batches = generateBatches(amount);
  var unsubscribe = subscribe(batches, function (batch) {
...
/******/ });
//# sourceMappingURL=batch-reactive.js.map