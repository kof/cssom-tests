...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/atomic-reactive.js");
/******/ })
/************************************************************************/
/******/ ({
...
var subscribe = function subscribe(samples, callback) {
  var index = 0;
  return Object(_common__WEBPACK_IMPORTED_MODULE_1__["raf"])(function () {
...
var generateSamples = function generateSamples(amount) {
  return (// [{rule: 'box-0': color: 'red'}, {rule: 'box-1': color: 'red'}]
    new Array(amount).fill(null).map(function (v, index) {
      return {
        rule: "box-".concat(lodash_random__WEBPACK_IMPORTED_MODULE_2___default()(0, amount - 1)),
...
Object(_common__WEBPACK_IMPORTED_MODULE_1__["renderControls"])(function (amount) {
  ...
  var samples = generateSamples(amount);
...
/******/ });
//# sourceMappingURL=atomic-reactive.js.map