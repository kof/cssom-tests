...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/atomic-immutable.js");
/******/ })
/************************************************************************/
/******/ ({
...
var generateSamples = function generateSamples(amount) {
  return (// [{rule: 'box-0': color: 'red'}, {rule: 'box-1': color: 'red'}]
    new Array(amount).fill(null).map(function (v, index) {
      return {
        rule: "box-".concat(index),
        color: Object(_common__WEBPACK_IMPORTED_MODULE_1__["getRandomColor"])()
      };
    })
  );
...
var diff = function diff(prevList, nextList, callback) {
...
Object(_common__WEBPACK_IMPORTED_MODULE_1__["renderControls"])(function (amount) {
  var _renderObjects = Object(_common__WEBPACK_IMPORTED_MODULE_1__["renderObjects"])(amount),
      remove = _renderObjects.remove,
      update = _renderObjects.update;

  var samples = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])(generateSamples(amount));
  var stop = Object(_common__WEBPACK_IMPORTED_MODULE_1__["raf"])(function () {
    var randomIndex = lodash_random__WEBPACK_IMPORTED_MODULE_2___default()(0, amount - 1);
    var nextSamples = samples.setIn([randomIndex, 'color'], Object(_common__WEBPACK_IMPORTED_MODULE_1__["getRandomColor"])());
...
/*!***********************!*\
  !*** ./src/common.js ***!
  \***********************/
/*! exports provided: getRandomColor, createStyles, createElements, renderControls, renderObjects, raf */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getRandomColor = function getRandomColor() {
  return "#".concat(Math.floor(Math.random() * 0x1000000).toString(16));
};
var createStyles = function createStyles(amount) {
  return new Array(amount).fill(null).reduce(function (styles, style, i) {
    return _objectSpread({}, styles, _defineProperty({}, "box-".concat(i), {
      float: 'left',
      width: '20px',
      height: '20px',
...
var createElements = function createElements(classNames) {
...
var renderControls = function renderControls(renderObjects) {
  var remove;
  var amount = 100;
  var buttonRender = document.createElement('button');
  buttonRender.innerText = "Render ".concat(amount);
...
var renderObjects = function renderObjects(amount) {
  var sheet = jss__WEBPACK_IMPORTED_MODULE_0___default.a.createStyleSheet(createStyles(amount), {
    link: true
  }).attach();
  var elements = createElements(Object.values(sheet.classes));
  ...
  var update = function update(rule, color) {
...
/******/ });
//# sourceMappingURL=atomic-immutable.js.map