...
var render = function render(renderObjects) {
  var remove;
  var amount = 100;
...
var subscribe = function subscribe(samples, callback) {
  var subscribed = true;
  var index = 0;
...
var generateSamplesPlain = function generateSamplesPlain(amount) {
  return (// [[{rule: 'box-0': color: 'red'}], [{rule: 'box-0': color: 'red'}]]
    new Array(1e3).fill(null).map(function () {
...
Object(_controls__WEBPACK_IMPORTED_MODULE_1__["render"])(function (amount) {
  var _renderObjects = renderObjects(amount),
      remove = _renderObjects.remove,
      update = _renderObjects.update;

  var samples = generateSamplesPlain(amount);
  var unsubscribe = subscribe(samples, update);
  return function () {
    unsubscribe();
    remove();
  };
...
var generateSamplesImmutable = function generateSamplesImmutable(amount) {
  return (// [[{rule: 'box-0': color: 'red'}], [{rule: 'box-0': color: 'red'}]]
    new Array(1e3).fill(null).map(function () {
      return new Array(amount).fill(null).map(function (v, index) {
        return new immutable__WEBPACK_IMPORTED_MODULE_2__["Map"]({
          rule: "box-".concat(index),
          color: getRandomColor()
        });
      });
...
Object(_controls__WEBPACK_IMPORTED_MODULE_1__["render"])(function (amount) {
  var _renderObjects2 = renderObjects(amount),
      remove = _renderObjects2.remove,
      update = _renderObjects2.update;

  var samples = generateSamplesImmutable(amount);
  var unsubscribe = subscribe(samples, update);
  return function () {
    unsubscribe();
    remove();
