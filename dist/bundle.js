...
var changes = new Array(1e5).fill(null).map(getRandomColor);
...
var animate = function animate(sheet) {
  var stop;
  var index = 0;

  var next = function next() {
    var change = changes[index];
    if (changes.length > index) index++;else index = 0;
    return change;
  };

  (function run() {
    for (var name in sheet.classes) {
...
Object(_controls__WEBPACK_IMPORTED_MODULE_1__["render"])(renderObjects);
